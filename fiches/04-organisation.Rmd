...
Il est possible de jouer sur le nombre de # pour hiérarchiser les titres sur plusieurs niveaux :
```{r, eval = FALSE}
...
RStudio tient compte de cette hiérarchie dans son plan du script (petite fenêtre document outline en haut à droite). Cette approche permet aussi de gagner en lisibilité générale du script : les titres et sous-titres forment des séparateurs visuels des différentes parties du programme.
 
Il peut être enfin utile de numéroter et de nommer les parties et sous-parties du script (tout comme on numérote les scripts dans une chaîne de traitement statistique) :
```{r, eval = FALSE}
# (I) Extraction des données ==================================================================
 
## (1) Données année précédente -----------------------------------------
 
### paramètres --------------------------------------
 
### chargement du csv -------------------------------
 
## (2) Données année actuelle -------------------------------------------
...
Sauter deux lignes avant chaque grande partie permet aussi de bien les différencier visuellement ; on peut aussi jouer sur la différence d’épaisseur entre = et -, ou la longueur des lignes de traits (===== ou -----).
